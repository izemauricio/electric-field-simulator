% Potencial [Volts]
% Tensao eletrica = DDP [Volts]

clc % CLEAR COMMAND WINDOW
close all; % CLOSE ALL FIGURES, WINDOWS, ETC
...
position_plate = 20; % Tamanho do espaço a partir do centro

P1 = -200;  % Potencial do prato 1
P2 = 200; % Potencial do prato 2

Nx = 100; % Número de colunas
Ny = 100; % Número de linhas
Ni = 100; % Número de iterações para a equação de poisson
...
for z=1:Ni
    for i=2:Nx-1
        for j=2:Ny-1
            ...
            V(pp1,mpy-lp:mpy+lp) = P1;
            V(pp2,mpy-lp:mpy+lp) = P2;
